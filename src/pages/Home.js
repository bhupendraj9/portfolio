...
/> 
  ...
  <a className='hidden md:flex px-6 -mx-2 bg-indigo-500 font-bold font-inter p-3  text-white ' href='../assets/RESUME.pdf'  download>My Resume</a>
  </div> 
   <div className='flex flex-col items-center gap-10'>
    ...
    <a className='flex bg-indigo-500 font-bold font-inter p-3 px-5 text-white md:hidden' href='../assets/RESUME.pdf' download>My Resume</a>
   </div>
   </div> 
